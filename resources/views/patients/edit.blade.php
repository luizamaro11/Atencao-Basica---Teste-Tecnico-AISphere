        ...
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white rounded-3xl overflow-hidden border border-stone-200/50 shadow-sm">
                ...
                <div class="p-8 sm:p-12">
                    <form method="POST" action="{{ route('patients.update', $patient) }}" enctype="multipart/form-data" class="space-y-10" x-data="{ isSubmitting: false }" @submit="isSubmitting = true">
                        @csrf
                        @method('PUT')

                        <!-- Profile Image Section -->
                        <div class="flex flex-col items-center justify-center space-y-4">
                            <div class="relative group cursor-pointer" x-data="{ photoName: null, photoPreview: '{{ $patient->profile_image ? asset('storage/' . $patient->profile_image) : '' }}' }">
                            ...
                            <div class="text-sm text-stone-500 font-medium">Clique para alterar a foto (opcional)</div>
                        </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <input type="tel" name="phone" id="phone" value="{{ old('phone', $patient->phone) }}" placeholder="(00) 00000-0000"
                            ...
                            <div>
                                ...
                                <input type="date" name="birth_date" id="birth_date" value="{{ old('birth_date', $patient->birth_date ? $patient->birth_date->format('Y-m-d') : '') }}"
                        ...
                        <div class="pt-8 flex items-center justify-end space-x-4">
                            ...
                            <button type="submit" :disabled="isSubmitting" class="relative px-8 py-4 bg-teal-600 rounded-full font-medium text-white hover:bg-teal-700 focus:outline-none focus:ring-4 focus:ring-teal-100 transition-all disabled:opacity-75 disabled:cursor-not-allowed">
                                <span x-show="!isSubmitting">Atualizar Informações</span>
