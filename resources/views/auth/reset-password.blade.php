<x-guest-layout>
    ...
    <div class="mb-8 text-center">
        <h2 class="text-2xl font-semibold text-stone-800">Redefinir Senha</h2>
        <p class="text-sm text-stone-500 mt-2">Escolha uma nova senha segura para sua conta.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-6">
        ...
        <!-- Nova Senha -->
        <div>
            <label for="password" class="block font-medium text-sm text-stone-600 mb-2">{{ __('Nova Senha') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
        ...
        <div>
            <label for="password_confirmation" class="block font-medium text-sm text-stone-600 mb-2">{{ __('Confirmar Nova Senha') }}</label>
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
